...
namespace PageModel
{
    ...
    public class HomePageModel : BaseSeleniumPageModel
    {
        ...
        /// Gets welcome message
        /// </summary>
        private LazyElement AboutNavButton
        {
            get { return this.GetLazyElement(By.CssSelector("#About"), "About navigation button"); }
        }

        public AboutPageModel ClickAboutNavigationButton()
        {
            this.AboutNavButton.Click();
